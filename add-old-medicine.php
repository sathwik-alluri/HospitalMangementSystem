       ...
       $result = mysqli_query($con,$query);
        ...
        else 
        {
            ...
            echo "<script>window.alert('Added Medicine Successfully');
             document.location='add-old-medicine.php';</script>";
        }
...
<li><a href="add-old-medicine.php" class="active">Add Existing Medicines</a></li>
...
<select name="medicine" value="" class="form-control" required>
   <?php
