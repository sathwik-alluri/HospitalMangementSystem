...
<ul>
<li><a href="recept-patients-list.php" class="active">Patients List</a></li>
...
$pid69=$_GET['a'];
$doc=date("Y-m-d");
$s1="UPDATE `patients` SET `d_o_c`='$doc',visited=NULL WHERE p_id='$pid69'";
...
<td>'.$run['type'].'</td>
<td>
<button type="button" pid69="'.$run['p_id'].'" pname69="'.$run['p_name'].'" class="btn btn-rounded btn-info" onclick="visit(this)">Add</button></td>
</tr>';
}
?>
</tbody>
...
<script>
   function visit(buttonElement) {
    ...
    if (confirm("Do you want to update "+patientName+" OP")==true) {
        window.location.href = 'recept-patients-list.php?a='+patientid;
    }   
}
</script>
