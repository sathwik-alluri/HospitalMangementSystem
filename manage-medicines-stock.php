...
<li><a href="manage-medicines-stock.php"  class="active">Medicines Stock</a></li> 
</ul>
</li>
<li class="submenu">
...
<button name="search" name="search" type="btn" class="btn btn-primary">Search</button>
</div>
</div> 
...
<div class="col">
<h3 class="page-title">Medicines Stock</h3>
</div>
</div>
</div>
                       ...
                       if(isset($_POST['search']))
                        {
                                ...
                                $query = " select * from `medicines` where CONCAT(mname,doctor) LIKE '%$value%' AND quantity_present != 0";
