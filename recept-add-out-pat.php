...
<ul>
<li><a href="recept-add-out-pat.php" class="active">Add Out-Patient</a></li>
...
if(isset($_GET['submit']))
{
    $sep=" ";
    $pid=$value2;
    $pname=$_GET['pfname'].$sep.$_GET['plname'];
    $age=$_GET['p_age'];
    $sex=$_GET['sex'];
    $height=$_GET['pheight'];
    $weight=$_GET['pweight'];
    ...
    $type=$_GET['type'];
    $add=$_GET['paddress'];
    $query="INSERT INTO `patients`(`p_id`, `p_name`, `age`, `sex`, `height`, `weight`, `p_num`, `d_o_c`, `type`, `address`) VALUES ('$pid','$pname','$age','$sex','$height','$weight','$pnum','$doc','$type','$add')";
    $run=mysqli_query($con,$query);
    echo "<script>
    window.alert('Added out-patient successfully!');
</script>";
}
?>
<div class="page-wrapper">
    ...
    <div class="col">
    <h3 class="page-title">Add Out-Patient </h3>
    <ul class="breadcrumb">
...
<input class="form-control" type="text" name="pfname" placeholder="Enter First Name">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Last Name <span class="login-danger">*</span></label>
<input class="form-control" type="text" name="plname" placeholder="Enter Last Name">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
...
<input class="form-control" name="p_age" type="number" placeholder="Enter Age">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Height</label>
<input class="form-control" type="number" name="pheight" placeholder="Enter Height of Patient">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Weight</label>
<input class="form-control" type="number" name="pweight" placeholder="Enter Weight of Patient">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Place <span class="login-danger">*</span></label>
<input class="form-control" type="text" name="paddress" placeholder="Enter Place">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
<label>Phone <span class="login-danger">*</span></label>
<input class="form-control" type="number" name="pcontact" placeholder="Enter Mobile Number">
</div>
</div>
<div class="col-12 col-sm-4">
<div class="form-group local-forms">
