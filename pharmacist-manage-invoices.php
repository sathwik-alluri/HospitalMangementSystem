...
<ul>
<li><a href="pharmacist-manage-invoices.php" class="active">Pharmacy Invoices</a></li>
</ul>
</li>
<li class="submenu">
                       ...
                       if(isset($_POST['search']))
                        {
                                ...
                                $query = " select * from `invoices` where CONCAT(invoice_id,customer_name,doctor,date,price) LIKE '%$value%' ORDER BY `date` DESC";
