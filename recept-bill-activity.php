...
<li><a href="recept-bill-activity.php" class="active">View Billing Activity</a></li>
...
<div class="col">
<h3 class="page-title">View Billing Activity</h3>
</div>
...
if(isset($_GET['search']))
{
    ...
    {
        $pname=$_GET['pname'];
        $s1="select * from patients where p_name like '%$pname%' and p_id in(select distinct p_id from billing_data)";
    }
}
else{
$s1="select * from patients where p_id in(select distinct p_id from billing_data)";
}
...
<td class="text-end">
<div class="actions">
<a href="recept-view-invoice.php?pid='.$run['p_id'].'" class="btn btn-sm bg-success-light me-2">
