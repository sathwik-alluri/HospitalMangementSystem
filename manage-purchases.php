...
<title>Medicine PurchasesS</title>
...
<li><a href="manage-purchases.php" class="active">Medicine Purchases</a></li> 
...
<div class="col">
<h3 class="page-title">Medicine Purchasess</h3>
</div>
</div>
</div>
                       ...
                       if(isset($_POST['search']))
                        {
                                ...
                                $query = " select * from `purchase` where CONCAT(date,mname,doctor,quantity_brought,cost) LIKE '%$value%'";
