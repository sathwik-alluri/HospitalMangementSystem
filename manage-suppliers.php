...
<li><a href="manage-suppliers.php" class="active">Suppliers Data</a></li> 
...
<div class="col">
<h3 class="page-title">Suppliers Data</h3>
</div>
</div>
</div>
                       ...
                       if(isset($_POST['search']))
                        {
                                ...
                                $query = " select * from `supplier` where CONCAT(sname,phone,licence_number,place) LIKE '%$value%'";
